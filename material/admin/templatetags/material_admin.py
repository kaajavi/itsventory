    ...
    for model, model_admin in site._registry.items():
        ...
        if has_module_perms:
            ...
            if True in perms.values():
                ...
                if hasattr(model_admin, 'hidden_level'):
                    print "{}   ---   {}".format(request.user.user_type, model_admin.hidden_level)
                    if model_admin.hidden_level <= request.user.user_type:
                        continue
                model_dict = {
